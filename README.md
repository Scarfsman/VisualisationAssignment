...
CleanData.py -> Removes data thats not used for my visualisations, formats the data to be more useful. transforms the souce data 'athlete_events.csv' into 'gold_df.csv'
